...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'facebookID', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'googleID', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'facebookAccessToken', 'nom', 'prenom', 'dnaiss', 'genre', 'tel', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'platsPoste', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'imageUser', 'plats', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getPlatsPoste()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPlatsPoste', []);

        return parent::getPlatsPoste();
    }
    ...
    public function setPlatsPoste($platsPoste)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPlatsPoste', [$platsPoste]);

        return parent::setPlatsPoste($platsPoste);
    }
    ...
    public function getDnaiss()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDnaiss', []);

        return parent::getDnaiss();
    }
    ...
    public function setDnaiss($dnaiss)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDnaiss', [$dnaiss]);

        return parent::setDnaiss($dnaiss);
    }
    ...
    public function addPlatsPoste(\AppBundle\Entity\Plat $platsPoste)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPlatsPoste', [$platsPoste]);

        return parent::addPlatsPoste($platsPoste);
    }
    ...
    public function removePlatsPoste(\AppBundle\Entity\Plat $platsPoste)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePlatsPoste', [$platsPoste]);

        return parent::removePlatsPoste($platsPoste);
    }
